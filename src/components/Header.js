          ...
          {user ? (
            <>
              ...
              <li className="relative" ref={dropdownRef}>
                ...
                {dropdownOpen && (
                  <div
                    className="absolute left-1/2 transform -translate-x-1/2 mt-2 w-64 bg-[#f3e5ab] border border-[#b22222] rounded shadow-lg z-50 text-center"
                  >
                    <Link
